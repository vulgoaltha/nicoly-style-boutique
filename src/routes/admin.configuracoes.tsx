...
function AdminSettings() {
  ...
  const storeForm = useForm<StoreData>({
    ...
    defaultValues: {
      ...
      store_email: getValue("store_email"),
      store_cnpj: getValue("store_cnpj"),
      store_logo_url: getValue("store_logo_url"),
    },
  });

  // --- 2. Endereço da Empresa ---
  const companyForm = useForm<CompanyAddress>({
    resolver: zodResolver(companyAddressSchema),
    defaultValues: {
      company_cep: getValue("company_cep"),
      company_street: getValue("company_street"),
      company_number: getValue("company_number"),
      company_complement: getValue("company_complement"),
      company_neighborhood: getValue("company_neighborhood"),
      company_city: getValue("company_city"),
      company_state: getValue("company_state"),
    },
  });

  // --- 3. Endereço de Devolução ---
  const returnForm = useForm<ReturnAddress>({
    resolver: zodResolver(returnAddressSchema),
    defaultValues: {
      return_cep: getValue("return_cep"),
      return_street: getValue("return_street"),
      return_number: getValue("return_number"),
      return_complement: getValue("return_complement"),
      return_neighborhood: getValue("return_neighborhood"),
      return_city: getValue("return_city"),
      return_state: getValue("return_state"),
    },
  });

  // --- 4. Conta Administrativa ---
  const accountForm = useForm<AdminAccount>({
    resolver: zodResolver(adminAccountSchema),
    defaultValues: {
      admin_name: getValue("admin_name"),
      admin_phone: getValue("admin_phone"),
      admin_role: getValue("admin_role"),
    },
  });
  ...
  const generalForm = useForm<GeneralSettings>({
    ...
    defaultValues: {
      ...
      timezone: getValue("timezone", "America/Sao_Paulo"),
  ...
  const shippingForm = useForm<ShippingSettings>({
    ...
    defaultValues: {
      ...
      shipping_provider: getValue("shipping_provider", "manual"),
      delivery_time_min: Number(getValue("delivery_time_min", 1)),
      delivery_time_max: Number(getValue("delivery_time_max", 10)),
    },
  });
  ...
  const seoForm = useForm<SeoSettings>({
    ...
    defaultValues: {
      ...
      site_keywords: getValue("site_keywords"),
    ...
    <div className="max-w-3xl space-y-10">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Gerencie dados da loja, endereços, contas e configurações gerais
        </p>
      </div>
      ...
      <SettingsSection title="Dados da Loja" description="Informações principais da sua loja.">
        <form
          onSubmit={storeForm.handleSubmit((data) => saveSetting("store_data", data))}
        ...
        >
          ...
          <div className="pt-2">
            ...
            >
              {saving === "store_data" ? "Salvando..." : "Salvar Dados da Loja"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Endereço da Empresa">
        <form
          onSubmit={companyForm.handleSubmit((data) => saveSetting("company_address", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                {...companyForm.register("company_cep")}
                className={inputClass}
            ...
            <div>
              ...
              <input
                {...companyForm.register("company_state")}
                className={inputClass}
                maxLength={2}
                placeholder="SP"
              />
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "company_address" ? "Salvando..." : "Salvar Endereço"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Endereço de Devolução">
        <form
          onSubmit={returnForm.handleSubmit((data) => saveSetting("return_address", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className={labelClass}>CEP</label>
              <input
                {...returnForm.register("return_cep")}
                className={inputClass}
                placeholder="00000-000"
              />
            </div>
            ...
            <div>
              <label className={labelClass}>Estado (UF)</label>
              <input
                {...returnForm.register("return_state")}
                className={inputClass}
                maxLength={2}
                placeholder="SP"
              />
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "return_address" ? "Salvando..." : "Salvar Endereço de Devolução"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Conta Administrativa">
        <form
          onSubmit={accountForm.handleSubmit((data) => saveSetting("admin_account", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "admin_account" ? "Salvando..." : "Salvar Conta"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Configurações de Email (SMTP)">
        <form
          onSubmit={emailSettingsForm.handleSubmit((data) => saveSetting("email_settings", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                {...emailSettingsForm.register("smtp_host")}
                className={inputClass}
            ...
            <div>
              ...
              <input
                type="number"
                {...emailSettingsForm.register("smtp_port")}
                className={inputClass}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                type="password"
                {...emailSettingsForm.register("smtp_password")}
                className={inputClass}
              />
            </div>
            <div className="md:col-span-2">
              ...
              <input
                {...emailSettingsForm.register("smtp_from")}
                className={inputClass}
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                {...emailSettingsForm.register("smtp_secure")}
                id="smtp_secure"
              />
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "email_settings" ? "Salvando..." : "Salvar Configurações de Email"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Configurações Gerais">
        <form
          onSubmit={generalForm.handleSubmit((data) => saveSetting("general_settings", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                {...generalForm.register("maintenance_mode")}
                id="maintenance_mode"
              />
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                {...generalForm.register("allow_register")}
                id="allow_register"
              />
              <label htmlFor="allow_register" className="text-sm">
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "general_settings" ? "Salvando..." : "Salvar Configurações Gerais"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Frete">
        <form
          onSubmit={shippingForm.handleSubmit((data) => saveSetting("shipping_settings", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="number"
                step="0.01"
                {...shippingForm.register("default_shipping_cost")}
                className={inputClass}
              />
            </div>
            <div>
              ...
              <input
                type="number"
                step="0.01"
                {...shippingForm.register("free_shipping_threshold")}
                className={inputClass}
              />
            </div>
            <div>
            ...
            <div className="flex gap-4">
              <div className="flex-1">
                ...
                <input
                  type="number"
                  {...shippingForm.register("delivery_time_min")}
                  className={inputClass}
                />
              </div>
              <div className="flex-1">
                ...
                <input
                  type="number"
                  {...shippingForm.register("delivery_time_max")}
                  className={inputClass}
                />
              </div>
            </div>
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "shipping_settings" ? "Salvando..." : "Salvar Configurações de Frete"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="SEO e Marketing">
        <form
          onSubmit={seoForm.handleSubmit((data) => saveSetting("seo_settings", data))}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 gap-4">
            <div>
            ...
            <div>
              ...
              <textarea
                {...seoForm.register("site_description")}
                className={inputClass}
                rows={3}
            ...
            <div>
              ...
              <input
                {...seoForm.register("site_keywords")}
                className={inputClass}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  {...seoForm.register("facebook_pixel_id")}
                  className={inputClass}
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "seo_settings" ? "Salvando..." : "Salvar SEO e Marketing"}
            </button>
          </div>
        </form>
      </SettingsSection>
      ...
      <SettingsSection title="Instagram" description="Configurações do Instagram oficial da loja.">
        <form
          onSubmit={(e) => {
            e.preventDefault();
            saveSetting("instagram", instagramForm);
          }}
          className={sectionClass}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setInstagramForm({ ...instagramForm, active: e.target.checked })}
                id="instagram_active"
              />
              <label htmlFor="instagram_active" className="text-sm">
                Exibir no site
              </label>
            </div>
          </div>
          <div className="pt-2">
            <button
              ...
              className="bg-primary text-primary-foreground px-5 py-2.5 text-xs tracking-editorial uppercase rounded-sm disabled:opacity-50"
            >
              {saving === "instagram" ? "Salvando..." : "Salvar Instagram"}
            </button>
          </div>
        </form>
      </SettingsSection>
