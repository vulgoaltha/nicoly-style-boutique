  ...
  return (
    <div>
      ...
      <div className="bg-background border border-border rounded-sm divide-y divide-border">
        ...
        {banners.map((b) => (
          <div key={b.id} className="p-4 flex flex-col sm:flex-row gap-4 sm:items-center">
            <div className="flex gap-4 items-center flex-1 min-w-0 w-full">
              <img
                src={b.image_url}
                alt=""
                className="w-24 h-14 sm:w-28 sm:h-16 object-cover rounded-sm bg-secondary shrink-0"
              />
            ...
            <div className="flex gap-1 sm:ml-auto w-full sm:w-auto mt-2 sm:mt-0 pt-2 sm:pt-0 border-t border-border sm:border-0 justify-end">
              <button onClick={() => move(b, -1)} className="p-2 hover:bg-secondary rounded-sm">
                <ArrowUp className="h-4 w-4" />
              </button>
              <button onClick={() => move(b, 1)} className="p-2 hover:bg-secondary rounded-sm">
                <ArrowDown className="h-4 w-4" />
              </button>
              <button onClick={() => setEditing(b)} className="p-2 hover:bg-secondary rounded-sm">
