    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Extremos do Mês</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-xs text-muted-foreground">Maior Pedido</p>
                <p className="text-lg font-bold text-emerald-600">{formatCurrency(data?.max_order_month)}</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Menor Pedido</p>
                <p className="text-lg font-bold text-rose-500">{formatCurrency(data?.min_order_month)}</p>
              </div>
            </CardContent>
          </Card>
        </div>
