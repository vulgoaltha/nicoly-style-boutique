      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {collections.map((c) => (
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-3xl shadow-md bg-gradient-to-br from-gray-50 to-gray-200 aspect-[2/1] transition-transform duration-500 group-hover:scale-[1.02] group-hover:shadow-lg">
              ...
              <OptimizedImage
                ...
                className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105 z-10"
              />
            </div>
