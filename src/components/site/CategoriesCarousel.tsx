...
export function CategoriesCarousel() {
  ...
  return (
    <section className="container-editorial my-10 md:my-14">
      <div className="flex items-end justify-between mb-5 md:mb-6">
        <div>
          <span className="text-xs tracking-editorial uppercase text-blush-deep">Categorias</span>
          <h2 className="font-display text-2xl md:text-3xl mt-1">Compre por estilo</h2>
        </div>
      ...
      <div
        ref={ref}
        className="flex gap-6 md:gap-10 overflow-x-auto snap-x snap-mandatory pb-3 -mx-4 px-4 scrollbar-hide md:justify-center justify-start items-start"
