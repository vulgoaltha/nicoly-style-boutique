...
const SERVICE_ROLE =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp5Y3d2YXRpbWpmYnNmbmpqdm5zIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MTE4NTU0NywiZXhwIjoyMDk2NzYxNTQ3fQ.dAsM5GPqtcbTmaqxx1gPsTSZGK9LOFivUns8xPL98d4";
...
async function runTests() {
  ...
  try {
    ...
    const { data: signUpData, error: signUpError } = await client.auth.signUp({
      email,
      password,
      options: { data: { name: "Usuário UAT", cpf: "12345678901", phone: "11999999999" } },
    });
    ...
    const rpcsWithArgs = ["get_product_performance", "get_sales_chart_data"];
