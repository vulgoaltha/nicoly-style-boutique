import { D as Oe } from "./index-C2UuTsl-.js";
function ye(e) {
  var t,
    r,
    o = "";
...
const We = (e, t) => {
  ...
  _e = (e) => {
    ...
    return {
      getClassGroupId: (l) => {
        if (l.startsWith("[") && l.endsWith("]")) return Be(l);
        const b = l.split(H),
  ...
  ze = (e, t, r) => {
    ...
    if (l === null) return;
    const b = t === 0 ? e.join(H) : e.slice(t).join(H),
      u = l.length;
    for (let m = 0; m < u; m++) {
      const h = l[m];
  ...
  Qe = (e) => {
    ...
    return {
      get(d) {
        ...
        if ((l = o[d]) !== void 0) return (i(d, l), l);
      },
      set(d, l) {
        d in r ? (r[d] = l) : i(d, l);
      },
  ...
  Ke = (e) => {
    ...
    if (t) {
      const i = t + ge,
        d = o;
      o = (l) => (l.startsWith(i) ? d(l.slice(i.length)) : he(He, !1, l, void 0, !0));
    }
    if (r) {
      const i = o;
      o = (d) => r({ className: d, parseClassName: i });
    }
    return o;
  },
  Ze = (e) => {
  ...
  no = (e, ...t) => {
    ...
    const l = (u) => {
        ...
        return ((r = eo(m)), (o = r.cache.get), (i = r.cache.set), (d = b), b(u));
      },
      b = (u) => {
        const m = o(u);
        if (m) return m;
  ...
  Ro = () => {
    const e = f("color"),
      ...
      Z = () => [M, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...a()],
      ee = () => [M, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...a()],
      c = () => [e, n, s],
      de = () => [...E(), we, ke, { position: [n, s] }],
      me = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      pe = () => ["auto", "cover", "contain", Co, ko, { size: [n, s] }],
      oe = () => [te, $, N],
      k = () => ["", "none", "full", m, n, s],
      w = () => ["", p, $, N],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", M, s, n, C] }],
        container: ["container"],
        ...
        z: [{ z: [I, "auto", n, s] }],
        basis: [{ basis: [M, "full", "auto", b, ...a()] }],
        "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [p, M, "auto", "initial", "none", s] }],
        grow: [{ grow: ["", p, n, s] }],
        shrink: [{ shrink: ["", p, n, s] }],
        ...
        "max-w": [{ "max-w": [b, "screen", "none", "prose", { screen: [l] }, ...j()] }],
        h: [{ h: ["screen", "lh", ...j()] }],
        ...
        "outline-w": [{ outline: ["", p, $, N] }],
        "outline-color": [{ outline: c() }],
        shadow: [{ shadow: ["", "none", h, Q, J] }],
        "shadow-color": [{ shadow: c() }],
        "inset-shadow": [{ "inset-shadow": ["none", x, Q, J] }],
        ...
        "text-shadow": [{ "text-shadow": ["none", T, Q, J] }],
        ...
        "drop-shadow": [{ "drop-shadow": ["", "none", S, Q, J] }],
...
function To({ className: e, ...t }) {
  return Oe.jsx("div", { className: Mo("animate-pulse rounded-md bg-primary/10", e), ...t });
}
export { To as S, Mo as a, Ee as c };
