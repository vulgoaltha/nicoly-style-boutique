import { r as m, j as u } from "./react.mjs";
import { a as $ } from "./radix-ui__react-context.mjs";
import { a as c } from "./radix-ui__react-primitive.mjs";
var l = "Progress",
  d = 100,
  [E] = $(l),
  [R, h] = E(l),
  f = m.forwardRef((r, e) => {
    const { __scopeProgress: i, value: o = null, max: a, getValueLabel: N = _, ...b } = r;
    (a || a === 0) && !v(a) && console.error(M(`${a}`, "Progress"));
    const t = v(a) ? a : d;
    o !== null && !p(o, t) && console.error(V(`${o}`, "Progress"));
    const s = p(o, t) ? o : null,
      I = n(s) ? N(s, t) : void 0;
    return u.jsx(R, {
      scope: i,
      value: s,
      max: t,
      children: u.jsx(c.div, {
        "aria-valuemax": t,
        "aria-valuemin": 0,
