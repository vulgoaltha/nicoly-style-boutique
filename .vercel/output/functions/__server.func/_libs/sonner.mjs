...
import { R as Ut } from "./react-dom.mjs";
function Xt(r) {
  ...
  qt = ({ visible: r, className: o }) =>
    a.createElement(
      ...
      a.createElement(
        ...
        Kt.map((e, s) =>
          a.createElement("div", { className: "sonner-loading-bar", key: `spinner-bar-${s}` }),
        ),
      ),
    ),
  Gt = a.createElement(
  ...
  constructor() {
    ((this.subscribe = (o) => (
      ...
      (this.create = (o) => {
        ...
        const { message: s, ...C } = o,
          u =
            typeof o?.id == "number" || ((e = o.id) == null ? void 0 : e.length) > 0 ? o.id : xt++,
      ...
      (this.dismiss = (o) => (
        o
          ? (this.dismissedToasts.add(o),
            requestAnimationFrame(() => this.subscribers.forEach((e) => e({ id: o, dismiss: !0 }))))
      ...
      (this.promise = (o, e) => {
        ...
        const _ = C.then(async (i) => {
          ...
          b = () =>
            new Promise((i, T) => _.then(() => (g[0] === "reject" ? T(g[1]) : i(g[1]))).catch(T));
  ...
  return a.createElement(
      ...
      onPointerUp: () => {
        ...
        const k = Number(
          ...
          ut = Number(
            ((h = P.current) == null
              ? void 0
              : h.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0,
          ),
        ...
        if (Math.abs(D) >= me || ft > 0.11) {
          ...
          var M, I;
          ((M = P.current) == null || M.style.setProperty("--swipe-amount-x", "0px"),
            (I = P.current) == null || I.style.setProperty("--swipe-amount-y", "0px"));
        }
        (q(!1), f(!1), B(null));
      },
      onPointerMove: (n) => {
        ...
        if (
          !J.current ||
          !G ||
          ((h = window.getSelection()) == null ? void 0 : h.toString().length) > 0
        )
          return;
        ...
        if ($ === "y") {
          if (M.includes("top") || M.includes("bottom"))
            if ((M.includes("top") && y < 0) || (M.includes("bottom") && y > 0)) I.y = y;
            else {
              const V = y * Bt(y);
              I.y = Math.abs(V) < Math.abs(y) ? V : y;
            }
        } else if ($ === "x" && (M.includes("left") || M.includes("right")))
          if ((M.includes("left") && D < 0) || (M.includes("right") && D > 0)) I.x = D;
          else {
            const V = D * Bt(D);
            I.x = Math.abs(V) < Math.abs(D) ? V : D;
          }
        ((Math.abs(I.x) > 0 || Math.abs(I.y) > 0) && q(!0),
          (w = P.current) == null || w.style.setProperty("--swipe-amount-x", `${I.x}px`),
          (k = P.current) == null || k.style.setProperty("--swipe-amount-y", `${I.y}px`));
      },
    },
    jt && !t.jsx && N !== "loading"
      ? a.createElement(
    ...
    (N || t.icon || t.promise) && t.icon !== null && (v?.[N] !== null || t.icon)
      ? a.createElement(
          ...
          t.promise || (t.type === "loading" && !t.icon) ? t.icon || Ft() : null,
        ...
        ? a.createElement(
            "div",
            {
              ...
              className: H(
                ...
                Pt,
                c?.description,
                t == null || (_ = t.classNames) == null ? void 0 : _.description,
              ),
            },
        ...
        ? a.createElement(
            "button",
            {
              ...
              onClick: (n) => {
                mt(t.cancel) &&
                  G &&
                  (t.cancel.onClick == null || t.cancel.onClick.call(t.cancel, n), L());
              },
              className: H(
                c?.cancelButton,
                t == null || (b = t.classNames) == null ? void 0 : b.cancelButton,
              ),
            },
            t.cancel.label,
          )
      ...
      : t.action && mt(t.action)
        ? a.createElement(
            "button",
            {
              ...
              onClick: (n) => {
                mt(t.action) &&
                  (t.action.onClick == null || t.action.onClick.call(t.action, n),
                  !n.defaultPrevented && L());
              },
              className: H(
                c?.actionButton,
                t == null || (i = t.classNames) == null ? void 0 : i.actionButton,
              ),
            },
            t.action.label,
          )
      ...
      typeof s == "number" || typeof s == "string"
        ...
        : typeof s == "object"
          ? ["top", "right", "bottom", "left"].forEach((i) => {
              s[i] === void 0
                ? (e[`${g}-${i}`] = _)
                : (e[`${g}-${i}`] = typeof s[i] == "number" ? `${s[i]}px` : s[i]);
            })
          : b(_);
    }),
    e
...
const Ee = a.forwardRef(function (o, e) {
  const {
      id: s,
      invert: C,
    ...
    ht = a.useMemo(
      () => Array.from(new Set([u].concat(Y.filter((l) => l.position).map((l) => l.position)))),
      [Y, u],
    ),
    [nt, bt] = a.useState([]),
    [tt, A] = a.useState(!1),
    ...
    it = a.useCallback((l) => {
      Z((p) => {
        var m;
        return (
          ((m = p.find((R) => R.id === l.id)) != null && m.delete) || S.dismiss(l.id),
  ...
  return (
        ...
        S.subscribe((l) => {
          if (l.dismiss) {
            requestAnimationFrame(() => {
              Z((p) => p.map((m) => (m.id === l.id ? { ...m, delete: !0 } : m)));
            });
            return;
          }
          setTimeout(() => {
    ...
    a.useEffect(() => {
      if (j.current)
        return () => {
          B.current &&
            (B.current.focus({ preventScroll: !0 }), (B.current = null), (F.current = !1));
        };
    }, [j.current]),
    a.createElement(
      "section",
              ...
              "ol",
              {
                ...
                onBlur: (f) => {
                  F.current &&
                    ...
                    ((F.current = !1),
                    B.current && (B.current.focus({ preventScroll: !0 }), (B.current = null)));
                },
                onFocus: (f) => {
