import { r as d, j as R } from "./react.mjs";
import { u as M } from "./radix-ui__react-compose-refs.mjs";
import { P as _ } from "./radix-ui__react-primitive.mjs";
import { u as y } from "./@radix-ui/react-use-callback-ref+[...].mjs";
var F = "focusScope.autoFocusOnMount",
  T = "focusScope.autoFocusOnUnmount",
  N = { bubbles: !1, cancelable: !0 },
  x = "FocusScope",
  K = d.forwardRef((e, t) => {
    const { loop: n = !1, trapped: u = !1, onMountAutoFocus: p, onUnmountAutoFocus: L, ...g } = e,
      [s, P] = d.useState(null),
      E = y(p),
      v = y(L),
      b = d.useRef(null),
        ...
        let o = function (i) {
          ...
          r = function (i) {
            if (document.activeElement === document.body)
              for (const h of i) h.removedNodes.length > 0 && f(s);
          };
      ...
      d.useEffect(() => {
        if (s) {
          ...
          if (!s.contains(o)) {
            ...
            (s.addEventListener(F, E),
              s.dispatchEvent(r),
              r.defaultPrevented ||
                (k(V(I(s)), { select: !0 }), document.activeElement === o && f(s)));
          }
          return () => {
            (s.removeEventListener(F, E),
              setTimeout(() => {
                ...
                (s.addEventListener(T, v),
                  s.dispatchEvent(r),
                  r.defaultPrevented || f(o ?? document.body, { select: !0 }),
                  s.removeEventListener(T, v),
                  O.remove(a));
              }, 0));
          };
        }
    ...
    const A = d.useCallback(
      (o) => {
        ...
        if (l && r) {
          ...
          i && c
            ? !o.shiftKey && r === c
              ? (o.preventDefault(), n && f(i, { select: !0 }))
              : o.shiftKey && r === i && (o.preventDefault(), n && f(c, { select: !0 }))
            : r === m && o.preventDefault();
        }
      },
      [n, u, a.paused],
    );
    return R.jsx(_.div, { tabIndex: -1, ...g, ref: U, onKeyDown: A });
  });
K.displayName = x;
function k(e, { select: t = !1 } = {}) {
  const n = document.activeElement;
  for (const u of e) if ((f(u, { select: t }), document.activeElement !== n)) return;
}
function w(e) {
  const t = I(e),
    n = S(t, e),
...
function S(e, t) {
  for (const n of e) if (!D(n, { upTo: t })) return n;
}
function D(e, { upTo: t }) {
