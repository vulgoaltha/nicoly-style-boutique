  ...
  function h(a, o) {
    return function (c) {
      ...
      for (c instanceof Date || (c = new Date(+c)); ++l < m; )
        a.charCodeAt(l) === 37 &&
          (r.push(a.slice(i, l)),
          (C = I[(y = a.charAt(++l))]) != null ? (y = a.charAt(++l)) : (C = y === "e" ? " " : "0"),
          (Z = o[y]) && (y = Z(c, C)),
          r.push(y),
          (i = l + 1));
    ...
    return function (c) {
      ...
      if (
        ...
        ("W" in r || "U" in r) &&
          ...
          (m = "Z" in r ? H(v(r.y, 0, 1)).getUTCDay() : F(v(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            "W" in r ? ((r.w + 6) % 7) + r.W * 7 - ((m + 5) % 7) : r.w + r.U * 7 - ((m + 6) % 7)));
      return "Z" in r ? ((r.H += (r.Z / 100) | 0), (r.M += r.Z % 100), H(r)) : F(r);
    };
  }
  function b(a, o, c, r) {
    for (var l = 0, i = o.length, m = c.length, y, C; l < i; ) {
      if (r >= m) return -1;
      if (((y = o.charCodeAt(l++)), y === 37)) {
        if (((y = o.charAt(l++)), (C = se[y in I ? o.charAt(l++) : y]), !C || (r = C(a, c, r)) < 0))
          return -1;
...
function Fn(e, n) {
  var t = e.getUTCDay();
  return ((e = t >= 4 || t === 0 ? k(e) : k.ceil(e)), f(e.getUTCFullYear() % 1e4, n, 4));
}
function Hn() {
  return "+0000";
}
...
function An(e) {
  return ((p = He(e)), (Nn = p.format), p.parse, (On = p.utcFormat), p.utcParse, p);
}
