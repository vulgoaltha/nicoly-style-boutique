import { I as C } from "./internmap.mjs";
import {
  r as gn,
  b as A,
  e as mn,
...
import { t as yn, u as vn } from "./d3-time-format.mjs";
import {
  s as Z,
  b as Mn,
  a as wn,
...
import { a as Ln, i as L, b as P, p as Pn } from "./d3-interpolate.mjs";
import { b as nn, p as jn, d as zn, c as Yn, a as Hn, f as tn } from "./d3-format.mjs";
function M(n, r) {
...
function N(n, r) {
  switch (arguments.length) {
    ...
    default: {
      (this.domain(n), typeof r == "function" ? this.interpolator(r) : this.range(r));
      break;
    }
  }
  return this;
...
function en() {
  ...
  function f() {
    var c = r().length,
      ...
      d = p ? a : t,
      m = p ? t : a;
    ((e = (m - d) / Math.max(1, c - l + o * 2)),
      s && (e = Math.floor(e)),
      (d += (m - d - e * (c - l)) * g),
      (i = e * (1 - l)),
      s && ((d = Math.round(d)), (i = Math.round(i))));
  ...
  return (
    ...
    (n.range = function (c) {
      return arguments.length ? (([t, a] = c), (t = +t), (a = +a), f()) : [t, a];
    }),
    (n.rangeRound = function (c) {
      return (([t, a] = c), (t = +t), (a = +a), (s = !0), f());
    }),
    ...
    (n.padding = function (c) {
      return arguments.length ? ((l = Math.min(1, (o = +c))), f()) : l;
    }),
    (n.paddingInner = function (c) {
      return arguments.length ? ((l = Math.min(1, c)), f()) : l;
    }),
    ...
    (n.copy = function () {
      return en(r(), [t, a]).round(s).paddingInner(l).paddingOuter(o).align(g);
    }),
    M.apply(f(), arguments)
  );
}
...
function Qn(n, r, u) {
  var t = Math.min(n.length, r.length) - 1,
    ...
    e = new Array(t),
    i = -1;
  for (n[t] < n[0] && ((n = n.slice().reverse()), (r = r.slice().reverse())); ++i < t; )
...
function F() {
  ...
  function g() {
    ...
    return (i !== y && (i = Cn(n[0], n[c - 1])), (s = c > 2 ? Qn : Un), (l = o = null), f);
  }
  function f(c) {
    return c == null || isNaN((c = +c)) ? e : (l || (l = s(n.map(t), r, u)))(t(i(c)));
  }
  return (
    (f.invert = function (c) {
      return i(a((o || (o = s(r, n.map(t), Ln)))(c)));
    }),
    (f.domain = function (c) {
...
function Wn(n, r, u, t) {
  ...
  switch (((t = nn(t ?? ",f")), t.type)) {
    case "s": {
      ...
      return (t.precision == null && !isNaN((e = Yn(a, i))) && (t.precision = e), Hn(t, i));
    }
    case "":
    case "e":
    case "g":
    ...
    case "f":
    case "%": {
      t.precision == null && !isNaN((e = jn(a))) && (t.precision = e - (t.type === "%") * 2);
      break;
    }
  }
  return tn(t);
  ...
  return (
    ...
    (n.nice = function (u) {
      ...
      var t = r(),
        ...
        o,
        g = 10;
      for (s < i && ((o = i), (i = s), (s = o), (o = a), (a = e), (e = o)); g-- > 0; ) {
        if (((o = pn(i, s, u)), o === l)) return ((t[a] = i), (t[e] = s), r(t));
        if (o > 0) ((i = Math.floor(i / o) * o), (s = Math.ceil(s / o) * o));
        else if (o < 0) ((i = Math.ceil(i * o) / o), (s = Math.floor(s * o) / o));
        else break;
        l = o;
      }
      return n;
...
function z(n) {
  ...
  return (
    ...
    (r.domain = function (s) {
      return arguments.length ? (u(s), i()) : u();
    }),
    (r.ticks = (s) => {
      const l = u();
      let o = l[0],
    ...
    (r.tickFormat = (s, l) => {
      if (
        ...
        l == null && (l = t === 10 ? "s" : ","),
        typeof l != "function" &&
          (!(t % 1) && (l = nn(l)).precision == null && (l.trim = !0), (l = tn(l))),
        s === 1 / 0)
      )
        return l;
      const o = Math.max(1, (t * s) / r.ticks().length);
      return (g) => {
        let f = g / e(Math.round(a(g)));
        return (f * t < t - 0.5 && (f *= t), f <= o ? l(g) : "");
      };
    }),
    (r.nice = () =>
      u(an(u(), { floor: (s) => e(Math.floor(a(s))), ceil: (s) => e(Math.ceil(a(s))) }))),
    r
  );
}
function Zn() {
...
function ut() {
  ...
  return (
    ...
    (a.range = function (e) {
      return arguments.length ? (n.range((r = Array.from(e, R)).map(V)), a) : r.slice();
    }),
...
function at() {
  ...
  function a() {
    ...
    for (u = new Array(s - 1); ++i < s; ) u[i - 1] = hn(n, i / s);
    return e;
  }
  function e(i) {
  ...
  return (
    (e.invertExtent = function (i) {
      var s = r.indexOf(i);
      return s < 0 ? [NaN, NaN] : [s > 0 ? u[s - 1] : n[0], s < u.length ? u[s] : n[n.length - 1]];
    }),
    (e.domain = function (i) {
      if (!arguments.length) return n.slice();
      n = [];
      for (let s of i) s != null && !isNaN((s = +s)) && n.push(s);
      return (n.sort(X), a());
    }),
    (e.range = function (i) {
...
function it() {
  var n = 0,
    ...
    e;
  function i(l) {
    return l != null && l <= l ? a[A(t, l, 0, u)] : e;
  }
  function s() {
    var l = -1;
    for (t = new Array(u); ++l < u; ) t[l] = ((l + 1) * r - (l - u) * n) / (u + 1);
    return i;
  }
  return (
    (i.domain = function (l) {
      return arguments.length ? (([n, r] = l), (n = +n), (r = +r), s()) : [n, r];
    }),
    (i.range = function (l) {
      return arguments.length ? ((u = (a = Array.from(l)).length - 1), s()) : a.slice();
    }),
    (i.invertExtent = function (l) {
      var o = a.indexOf(l);
      return o < 0 ? [NaN, NaN] : o < 1 ? [n, t[0]] : o >= u ? [t[u - 1], r] : [t[o - 1], t[o]];
    }),
    (i.unknown = function (l) {
      return (arguments.length && (e = l), i);
    }),
...
function B(n, r, u, t, a, e, i, s, l, o) {
  var g = j(),
    f = g.invert,
    c = g.domain,
    p = o(".%L"),
  ...
  return (
    ...
    (g.domain = function (h) {
      return arguments.length ? c(Array.from(h, st)) : c().map(ct);
    }),
    (g.ticks = function (h) {
      var k = c();
    ...
    (g.nice = function (h) {
      var k = c();
      return (
        (!h || typeof h.range != "function") && (h = r(k[0], k[k.length - 1], h ?? 10)),
        h ? c(an(k, h)) : g
      );
    }),
    (g.copy = function () {
      return S(g, B(n, r, u, t, a, e, i, s, l, o));
    }),
    g
  );
}
function At() {
  return M.apply(
    B(Sn, An, qn, bn, Nn, kn, wn, Mn, Z, yn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments,
  );
}
function St() {
  return M.apply(
    B($n, Tn, En, On, Fn, Rn, Dn, In, Z, vn).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
    arguments,
  );
}
function O() {
  ...
  function o(f) {
    return f == null || isNaN((f = +f))
      ? l
      : i(a === 0 ? 0.5 : ((f = (e(f) - u) * a), s ? Math.max(0, Math.min(1, f)) : f));
  }
  ((o.domain = function (f) {
    return arguments.length
      ? (([n, r] = f), (u = e((n = +n))), (t = e((r = +r))), (a = u === t ? 0 : 1 / (t - u)), o)
      : [n, r];
  }),
    (o.clamp = function (f) {
  ...
  return (
    ...
    function (f) {
      return ((e = f), (u = f(n)), (t = f(r)), (a = u === t ? 0 : 1 / (t - u)), o);
    }
  );
}
function q(n, r) {
  return r.domain(n.domain()).interpolator(n.interpolator()).clamp(n.clamp()).unknown(n.unknown());
}
function lt() {
  var n = b(O()(y));
  return (
...
function mt() {
  var n = [],
    r = y;
  function u(t) {
    if (t != null && !isNaN((t = +t))) return r((A(n, t, 1) - 1) / (n.length - 1));
  }
  return (
    (u.domain = function (t) {
      if (!arguments.length) return n.slice();
...
function E() {
  ...
  function d(m) {
    return function (w) {
      var v, I, D;
      return arguments.length ? (([v, I, D] = w), (o = Pn(m, [v, I, D])), p) : [o(0), o(0.5), o(1)];
    };
  }
  return (
    (p.range = d(L)),
...
function sn() {
  ...
  return (
    (n.copy = function () {
      return q(n, sn()).exponent(n.exponent());
    }),
    N.apply(n, arguments)
  );
}
function Dt() {
  return sn.apply(null, arguments).exponent(0.5);
}
export {
  At as A,
  St as B,
