import { P as ot } from "./d3-path.mjs";
function a(t) {
  return function () {
    return t;
  };
...
function st(t, n) {
  ...
  function r(c) {
    ...
    for (o == null && (e = s((v = h()))), l = 0; l <= _; ++l)
      (!(l < _ && i((u = c[l]), l, c)) === f && ((f = !f) ? e.lineStart() : e.lineEnd()),
        f && e.point(+t(u, l, c), +n(u, l, c)));
    if (v) return ((e = null), v + "" || null);
  }
  return (
    (r.x = function (c) {
      return arguments.length ? ((t = typeof c == "function" ? c : a(+c)), r) : t;
    }),
    (r.y = function (c) {
      return arguments.length ? ((n = typeof c == "function" ? c : a(+c)), r) : n;
    }),
    (r.defined = function (c) {
      return arguments.length ? ((i = typeof c == "function" ? c : a(!!c)), r) : i;
    }),
    (r.curve = function (c) {
      return arguments.length ? ((s = c), o != null && (e = s(o)), r) : s;
    }),
    (r.context = function (c) {
      return arguments.length ? (c == null ? (o = e = null) : (e = s((o = c))), r) : o;
    }),
    r
  );
}
function Tt(t, n, i) {
    ...
    for (e == null && (r = h((A = c()))), f = 0; f <= y; ++f) {
      if (!(f < y && s((d = u[f]), f, u)) === x)
        if ((x = !x)) ((v = f), r.areaStart(), r.lineStart());
          ...
          for (r.lineEnd(), r.lineStart(), m = f - 1; m >= v; --m) r.point(M[m], B[m]);
          (r.lineEnd(), r.areaEnd());
        }
      x &&
        ((M[f] = +t(d, f, u)),
  ...
  return (
    (l.x = function (u) {
      return arguments.length ? ((t = typeof u == "function" ? u : a(+u)), (o = null), l) : t;
    }),
    (l.x0 = function (u) {
      return arguments.length ? ((t = typeof u == "function" ? u : a(+u)), l) : t;
    }),
    (l.x1 = function (u) {
    ...
    (l.y = function (u) {
      return arguments.length ? ((n = typeof u == "function" ? u : a(+u)), (i = null), l) : n;
    }),
    (l.y0 = function (u) {
      return arguments.length ? ((n = typeof u == "function" ? u : a(+u)), l) : n;
    }),
    (l.y1 = function (u) {
      return arguments.length
    ...
    (l.defined = function (u) {
      return arguments.length ? ((s = typeof u == "function" ? u : a(!!u)), l) : s;
    }),
    (l.curve = function (u) {
      return arguments.length ? ((h = u), e != null && (r = h(e)), l) : h;
    }),
    (l.context = function (u) {
      return arguments.length ? (u == null ? (e = r = null) : (r = h((e = u))), l) : e;
    }),
    l
  );
}
...
const rt = {
  ...
  yt = {
    draw(t, n) {
      const i = g(n / ht),
        o = i * Q;
      (t.moveTo(0, -i), t.lineTo(o, 0), t.lineTo(0, i), t.lineTo(-o, 0), t.closePath());
    },
  },
  dt = {
    draw(t, n) {
  ...
  bt = {
    draw(t, n) {
      const i = -g(n / (O * 3));
      (t.moveTo(0, i * 2), t.lineTo(-O * i, -i), t.lineTo(O * i, -i), t.closePath());
    },
  },
  p = -0.5,
  T = g(3) / 2,
...
function kt(t, n) {
  ...
  function s() {
    let e;
    if ((i || (i = e = o()), t.apply(this, arguments).draw(i, +n.apply(this, arguments)), e))
      return ((i = null), e + "" || null);
  }
  return (
    (s.type = function (e) {
      return arguments.length ? ((t = typeof e == "function" ? e : a(e)), s) : t;
    }),
    (s.size = function (e) {
      return arguments.length ? ((n = typeof e == "function" ? e : a(+e)), s) : n;
    }),
...
function R(t, n, i) {
  var o = t._x1 - t._x0,
    ...
    h = (i - t._y1) / (s || (o < 0 && -0)),
    r = (e * s + h * o) / (o + s);
  return (Y(e) + Y(h)) * Math.min(Math.abs(e), Math.abs(h), 0.5 * Math.abs(r)) || 0;
}
function W(t, n) {
  var i = t._x1 - t._x0;
    ...
    if (i)
      if (
        ...
        for (var o = D(t), s = D(n), e = 0, h = 1; h < i; ++e, ++h)
          this._context.bezierCurveTo(o[0][e], s[0][e], o[1][e], s[1][e], t[h], n[h]);
...
function D(t) {
  ...
  for (s[i - 1] = 2, e[i - 1] = 7, h[i - 1] = 8 * t[i - 1] + t[i], n = 1; n < i; ++n)
    ((o = s[n] / e[n - 1]), (e[n] -= o), (h[n] -= o * h[n - 1]));
  for (s[i - 1] = h[i - 1] / e[i - 1], n = i - 2; n >= 0; --n) s[n] = (h[n] - s[n + 1]) / e[n];
  for (e[i - 1] = (t[i] + s[i - 1]) / 2, n = 0; n < i - 1; ++n) e[n] = 2 * t[n + 1] - s[n + 1];
  return [s, e];
}
function Mt(t) {
  return new et(t);
...
function qt() {
  ...
  function s(e) {
    var h = Array.from(t.apply(this, arguments), _t),
      ...
      l = -1,
      _;
    for (const u of e) for (r = 0, ++l; r < c; ++r) (h[r][l] = [0, +o(u, h[r].key, l, e)]).data = u;
    for (r = 0, _ = X(n(h)); r < c; ++r) h[_[r]].index = r;
    return (i(h, _), h);
  }
  return (
    (s.keys = function (e) {
      return arguments.length ? ((t = typeof e == "function" ? e : a(Array.from(e))), s) : t;
    }),
    (s.value = function (e) {
      return arguments.length ? ((o = typeof e == "function" ? e : a(+e)), s) : o;
    }),
    (s.order = function (e) {
      return arguments.length
        ? ((n = e == null ? I : typeof e == "function" ? e : a(Array.from(e))), s)
        : n;
    }),
    (s.offset = function (e) {
  ...
  if (!(!((h = t.length) > 0) || !((e = (s = t[n[0]]).length) > 0))) {
    for (var i = 0, o = 1, s, e, h; o < e; ++o) {
      for (var r = 0, c = 0, l = 0; r < h; ++r) {
        for (
          var _ = t[n[r]], u = _[o][1] || 0, f = _[o - 1][1] || 0, v = (u - f) / 2, m = 0;
          m < r;
          ++m
        ) {
          var y = t[n[m]],
