const Oe = (e, t) => {
  ...
  ke = (e = new Map(), t = null, r) => ({ nextPart: e, validators: t, classGroupId: r });
const be = [],
  Ee = "arbitrary..",
  Le = (e) => {
    const t = Ne(e),
...
const Ue = [],
  ...
  Ye = (e) => {
    ...
    if (r) {
      const c = o;
      o = (d) => r({ className: d, parseClassName: c });
    }
    return o;
  },
  qe = (e) => {
  ...
  vo = () => {
    const e = f("color"),
      ...
      de = () => ["auto", "cover", "contain", ko, bo, { size: [n, s] }],
      ee = () => [re, D, L],
      x = () => ["", "none", "full", m, n, s],
      w = () => ["", p, D, L],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", T, s, n, A] }],
        container: ["container"],
        ...
        z: [{ z: [S, "auto", n, s] }],
        basis: [{ basis: [T, "full", "auto", b, ...a()] }],
        "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [p, T, "auto", "initial", "none", s] }],
        grow: [{ grow: ["", p, n, s] }],
        shrink: [{ shrink: ["", p, n, s] }],
        ...
        w: [{ w: [b, "screen", ...E()] }],
        "min-w": [{ "min-w": [b, "screen", "none", ...E()] }],
        "max-w": [{ "max-w": [b, "screen", "none", "prose", { screen: [i] }, ...E()] }],
        h: [{ h: ["screen", "lh", ...E()] }],
        "min-h": [{ "min-h": ["screen", "lh", "none", ...E()] }],
        "max-h": [{ "max-h": ["screen", "lh", ...E()] }],
        "font-size": [{ text: ["base", r, D, L] }],
        "font-smoothing": ["antialiased", "subpixel-antialiased"],
        "font-style": ["italic", "not-italic"],
        "font-weight": [{ font: [o, wo, uo] }],
        "font-stretch": [
          {
            "font-stretch": [
              "ultra-condensed",
        ...
        "inset-shadow": [{ "inset-shadow": ["none", k, Q, J] }],
        ...
        "text-shadow": [{ "text-shadow": ["none", O, Q, J] }],
        ...
        "drop-shadow": [{ "drop-shadow": ["", "none", R, Q, J] }],
