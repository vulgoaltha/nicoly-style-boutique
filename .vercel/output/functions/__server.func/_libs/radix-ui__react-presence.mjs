import { r as i } from "./react.mjs";
import { u as y } from "./radix-ui__react-compose-refs.mjs";
import { u as A } from "./@radix-ui/react-use-layout-effect+[...].mjs";
function E(n, e) {
...
var T = (n) => {
  const { present: e, children: t } = n,
    r = P(e),
    a = typeof t == "function" ? t({ present: r.isPresent }) : i.Children.only(t),
    c = y(r.ref, R(a));
