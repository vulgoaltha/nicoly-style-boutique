    ...
    e = N(f),
      ...
      n == 0 || n == 1 / 0
        ? ((r = q(f.d)),
          ...
          n == 1 / 0
            ? (r = "5e" + e)
            : ((r = n.toExponential()), (r = r.slice(0, r.indexOf("e") + 1) + e)),
          (t = new u(r)))
        : (t = new u(n.toString())),
      o = u.precision,
      n = s = o + 3;
...
c.toDecimalPlaces = c.todp = function (e, r) {
  ...
  return (
    ...
    e === void 0
      ? o
      : (k(e, 0, U), r === void 0 ? (r = t.rounding) : k(r, 0, 8), p(o, e + N(o) + 1, r))
  );
};
...
function y(e, r) {
  ...
  if (((u = e.d), (h = r.d), (s = e.e), (n = r.e), (u = u.slice()), (i = s - n), i)) {
    for (
      i < 0 ? ((t = u), (i = -i), (f = h.length)) : ((t = h), (n = s), (f = u.length)),
        s = Math.ceil(d / w),
        f = s > f ? s + 1 : f + 1,
        i > f && ((i = f), (t.length = 1)),
        t.reverse();
...
var I = (function () {
  function e(t, n) {
    var i,
      s = 0,
      f = t.length;
    for (t = t.slice(); f--; ) ((i = t[f] * n + s), (t[f] = (i % D) | 0), (s = (i / D) | 0));
  ...
  function o(t, n, i) {
    for (var s = 0; i--; ) ((t[i] -= s), (s = t[i] < n[i] ? 1 : 0), (t[i] = s * D + t[i] - n[i]));
  ...
  return function (t, n, i, s) {
    ...
    for (
      u = t.e - n.e, C = m.length, G = _.length, a = new X(te), P = a.d = [], h = 0;
      m[h] == (_[h] || 0);
    )
      ++h;
    if (
      (m[h] > (_[h] || 0) && --u,
      i == null ? (M = i = X.precision) : s ? (M = i + (N(t) - N(n)) + 1) : (M = i),
      M < 0)
    )
      return new X(0);
    if (((M = (M / w + 2) | 0), (h = 0), C == 1))
      ...
      for (
        l = (D / (m[0] + 1)) | 0,
          l > 1 && ((m = e(m, l)), (_ = e(_, l)), (C = m.length), (G = _.length)),
          H = C,
          g = _.slice(0, C),
          E = g.length;
        E < C;
        ...
        ((l = 0),
          ...
          f < 0
            ? ((B = g[0]),
              ...
              o(g, d, E),
              f == -1 &&
                ((E = g.length), (f = r(m, g, C, E)), f < 1 && (l++, o(g, C < E ? W : m, E))),
              (E = g.length))
            : f === 0 && (l++, (g = [0])),
          (P[h++] = l),
...
function ee(e, r) {
  ...
  for (v = !1, f = d, s = new l(0.03125); e.abs().gte(0.1); ) ((e = e.times(s)), (h += 5));
  for (
...
function b(e, r) {
  ...
  if (
    ((h += O), (g.precision = h), (o = q(P)), (t = o.charAt(0)), (i = N(a)), Math.abs(i) < 15e14)
  ) {
        ...
        o < 4
          ...
          : f > 5 ||
            (f == 5 &&
              (o == 4 ||
                u ||
                (o == 6 && ((t > 0 ? (n > 0 ? h / x(10, s - n) : 0) : d[l - 1]) % 10) & 1) ||
                o == (e.s < 0 ? 8 : 7))))),
    r < 1 || !d[0])
  )
    return (
...
function re(e, r) {
  ...
  if (((u = e.d), (d = r.d), (t = r.e), (h = e.e), (u = u.slice()), (s = h - t), s)) {
    for (
      l = s < 0,
        l ? ((o = u), (s = -s), (f = d.length)) : ((o = d), (t = h), (f = u.length)),
  ...
  for (l && ((o = u), (u = d), (d = o), (r.s = -r.s)), f = u.length, n = d.length - f; n > 0; --n)
    u[f++] = 0;
  for (n = d.length; n > s; ) {
    if (u[--n] < d[n]) {
...
function ie(e) {
  ...
  if (
    ...
    for (t = ["precision", "rounding", "toExpNeg", "toExpPos", "LN10"], r = 0; r < t.length; )
...
function se(e) {
  ...
  var r,
    o,
    t,
    n = ["precision", 1, U, "rounding", 0, 8, "toExpNeg", -1 / 0, 0, "toExpPos", 0, 1 / 0];
