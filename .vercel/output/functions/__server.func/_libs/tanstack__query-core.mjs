...
function X(t, e) {
  const { type: s = "all", exact: i, fetchStatus: r, predicate: n, queryKey: o, stale: u } = t;
  if (o) {
    if (i) {
      if (e.queryHash !== V(o, e.options)) return !1;
    } else if (!E(e.queryKey, o)) return !1;
  }
  if (s !== "all") {
    const a = e.isActive();
...
function Y(t, e) {
  ...
  if (n) {
    ...
    if (s) {
      if (T(e.options.mutationKey) !== T(n)) return !1;
    } else if (!E(e.options.mutationKey, n)) return !1;
  }
  ...
  return t === e
    ...
    : typeof t != typeof e
      ...
      : t && e && typeof t == "object" && typeof e == "object"
        ? Object.keys(e).every((s) => E(t[s], e[s]))
        : !1;
}
...
function ct(t) {
  return (t ?? "online") === "online" ? k.isOnline() : !0;
}
...
function lt(t) {
  ...
  const r = N(),
    ...
    f = () => W.isFocused() && (t.networkMode === "always" || k.isOnline()) && t.canRun(),
    h = () => ct(t.networkMode) && t.canRun(),
    y = (c) => {
      n() || (i?.(), r.resolve(c));
    },
    l = (c) => {
    ...
    d = () => {
      ...
      Promise.resolve(c)
        ...
        .catch((b) => {
          if (n()) return;
          const w = t.retry ?? (K.isServer() ? 0 : 3),
            P = t.retryDelay ?? Tt,
            R = typeof P == "function" ? P(s, b) : P,
            M = w === !0 || (typeof w == "number" && s < w) || (typeof w == "function" && w(s, b));
          if (e || !M) {
            l(b);
            return;
          }
...
var dt = class {
  ...
  updateGcTime(t) {
    this.gcTime = Math.max(this.gcTime || 0, t ?? (K.isServer() ? 1 / 0 : 300 * 1e3));
  }
  clearGcTimeout() {
    this.#t !== void 0 && (Q.clearTimeout(this.#t), (this.#t = void 0));
  }
};
function Dt(t) {
  return {
    onFetch: (e, s) => {
      ...
      const f = async () => {
        ...
        const y = (d) => {
          ...
          l = ht(e.options, e.fetchOptions),
          m = async (d, c, v) => {
            if (h) return Promise.reject(e.signal.reason);
            ...
            const w = (() => {
              ...
              M = v ? Ft : Pt;
            return { pages: M(d.pages, P, R), pageParams: M(d.pageParams, c, R) };
          };
        if (r && n.length) {
          const d = r === "backward",
            c = d ? It : st,
            v = { pages: n, pageParams: o },
            b = c(i, v);
          u = await m(v, b, d);
        } else {
          const d = t ?? n.length;
          do {
            const c = a === 0 ? (o[0] ?? i.initialPageParam) : st(i, u);
            if (a > 0 && c == null) break;
            ((u = await m(u, c)), a++);
          } while (a < d);
        }
...
var Et = class extends dt {
  ...
  setOptions(t) {
    if (
      ...
      const e = rt(this.options);
      e.data !== void 0 && (this.setState(it(e.data, e.dataUpdatedAt)), (this.#e = e));
    }
  }
  optionalRemove() {
  ...
  cancel(t) {
    ...
    return (this.#r?.cancel(t), e ? e.then(S).catch(S) : Promise.resolve());
  }
  destroy() {
  ...
  isDisabled() {
    return this.getObserversCount() > 0
      ? !this.isActive()
      : this.options.queryFn === $ || !this.isFetched();
  }
  isFetched() {
  ...
  addObserver(t) {
    this.observers.includes(t) ||
      ...
      this.clearGcTimeout(),
      this.#i.notify({ type: "observerAdded", query: this, observer: t }));
  }
  removeObserver(t) {
    this.observers.includes(t) &&
      ((this.observers = this.observers.filter((e) => e !== t)),
      this.observers.length ||
        (this.#r && (this.#a || this.#c() ? this.#r.cancel({ revert: !0 }) : this.#r.cancelRetry()),
        this.scheduleGc()),
      this.#i.notify({ type: "observerRemoved", query: this, observer: t }));
  }
  getObserversCount() {
  ...
  async fetch(t, e) {
    ...
    if ((t && this.setOptions(t), !this.options.queryFn)) {
      const a = this.observers.find((f) => f.options.queryFn);
    ...
    const s = new AbortController(),
      ...
      r = () => {
        const a = ht(this.options, e),
          h = (() => {
            const y = { client: this.#n, queryKey: this.queryKey, meta: this.meta };
            return (i(y), y);
          })();
        return ((this.#a = !1), this.options.persister ? this.options.persister(a, h, this) : a(h));
      },
      o = (() => {
        const a = {
          fetchOptions: e,
    ...
    ((this.#t === "infinite" ? Dt(this.options.pages) : this.options.behavior)?.onFetch(o, this),
      (this.#s = this.state),
      ...
      (this.#r = lt({
        ...
        fn: o.fetchFn,
        onCancel: (a) => {
          (a instanceof B && a.revert && this.setState({ ...this.#s, fetchStatus: "idle" }),
            s.abort());
        },
        onFail: (a, f) => {
          this.#u({ type: "failed", failureCount: a, error: f });
        },
        onPause: () => {
          this.#u({ type: "pause" });
        },
    ...
    try {
      ...
      return (
        this.setData(a),
        this.#i.config.onSuccess?.(a, this),
        this.#i.config.onSettled?.(a, this.state.error, this),
        a
      );
    } catch (a) {
      if (a instanceof B) {
      ...
      throw (
        ...
        this.#i.config.onError?.(a, this),
        this.#i.config.onSettled?.(this.state.data, a, this),
        a
      );
    } finally {
      this.scheduleGc();
  ...
  #u(t) {
    const e = (s) => {
      switch (t.type) {
        ...
        case "fetch":
          return { ...s, ...ft(s.data, this.options), fetchMeta: t.meta ?? null };
        case "success":
          const i = {
            ...s,
...
var kt = class extends D {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      nt(this.#e, this.options) ? this.#f() : this.updateResult(),
      this.#g());
  }
  onUnsubscribe() {
  ...
  shouldFetchOnReconnect() {
    return z(this.#e, this.options, this.options.refetchOnReconnect);
  }
  ...
  setOptions(t) {
    ...
    (i && at(this.#e, s, this.options, e) && this.#f(),
      this.updateResult(),
      i &&
        (this.#e !== s ||
          g(this.options.enabled, this.#e) !== g(e.enabled, this.#e) ||
          C(this.options.staleTime, this.#e) !== C(e.staleTime, this.#e)) &&
        this.#v());
    const r = this.#m();
    i &&
      (this.#e !== s ||
  ...
  getOptimisticResult(t) {
    ...
    return (jt(this, s) && ((this.#i = s), (this.#r = this.options), (this.#n = this.#e.state)), s);
  }
  getCurrentResult() {
    return this.#i;
  }
      ...
      get: (s, i) => (
        ...
        i === "promise" &&
          ...
          !this.options.experimental_prefetchInRender &&
            ...
            this.#o.reject(new Error("experimental_prefetchInRender feature flag is not enabled"))),
        Reflect.get(s, i)
      ),
    });
  }
  ...
  #v() {
    this.#O();
    const t = C(this.options.staleTime, this.#e);
    if (K.isServer() || this.#i.isStale || !H(t)) return;
  ...
  #b(t) {
    (this.#S(),
      (this.#h = t),
      !(K.isServer() || g(this.options.enabled, this.#e) === !1 || !H(this.#h) || this.#h === 0) &&
        (this.#d = Q.setInterval(() => {
          (this.options.refetchIntervalInBackground || W.isFocused()) && this.#f();
        }, this.#h)));
  }
  #g() {
  ...
  #O() {
    this.#l !== void 0 && (Q.clearTimeout(this.#l), (this.#l = void 0));
  }
  #S() {
    this.#d !== void 0 && (Q.clearInterval(this.#d), (this.#d = void 0));
  }
  createResult(t, e) {
    const s = this.#e,
      i = this.options,
    ...
    if (e._optimisticResults) {
      const O = this.hasListeners(),
        I = !O && nt(t, e),
        A = O && at(t, s, e, i);
      ((I || A) && (h = { ...h, ...ft(f.data, t.options) }),
        e._optimisticResults === "isRestoring" && (h.fetchStatus = "idle"));
    }
    let { error: m, errorUpdatedAt: d, status: c } = h;
    l = h.data;
    let v = !1;
    if (e.placeholderData !== void 0 && l === void 0 && c === "pending") {
      let O;
      (r?.isPlaceholderData && e.placeholderData === o?.placeholderData
        ...
        : (O =
            typeof e.placeholderData == "function"
              ...
              : e.placeholderData),
        O !== void 0 && ((c = "success"), (l = _(r?.data, O, e)), (y = !0)));
    }
    if (e.select && l !== void 0 && !v)
      if (r && l === n?.data && e.select === this.#c) l = this.#u;
      else
        try {
          ((this.#c = e.select),
            (l = e.select(l)),
    ...
    this.#a && ((m = this.#a), (l = this.#u), (d = Date.now()), (c = "error"));
    const b = h.fetchStatus === "fetching",
      ...
      F = {
        ...
        isFetchedAfterMount:
          h.dataUpdateCount > a.dataUpdateCount || h.errorUpdateCount > a.errorUpdateCount,
        isFetching: b,
        isRefetching: b && !w,
        isLoadingError: P && !M,
        ...
        promise: this.#o,
        isEnabled: g(e.enabled, t) !== !1,
      };
    if (this.options.experimental_prefetchInRender) {
      const O = F.data !== void 0,
        I = F.status === "error" && !O,
        A = (U) => {
          I ? U.reject(F.error) : O && U.resolve(F.data);
        },
        Z = () => {
          const U = (this.#o = F.promise = N());
          A(U);
        },
        j = this.#o;
      switch (j.status) {
  ...
  updateResult() {
    ...
    if (
      ((this.#n = this.#e.state),
      (this.#r = this.options),
      this.#n.data !== void 0 && (this.#p = this.#e),
      q(e, t))
    )
      return;
    this.#i = e;
...
function At(t, e) {
  return (
    g(e.enabled, t) !== !1 &&
    t.state.data === void 0 &&
    !(t.state.status === "error" && g(e.retryOnMount, t) === !1)
  );
}
function nt(t, e) {
  return At(t, e) || (t.state.data !== void 0 && z(t, e, e.refetchOnMount));
}
function z(t, e, s) {
  if (g(e.enabled, t) !== !1 && C(e.staleTime, t) !== "static") {
    const i = typeof s == "function" ? s(t) : s;
    return i === "always" || (i !== !1 && J(t, e));
  }
  return !1;
}
function at(t, e, s, i) {
  return (
    (t !== e || g(i.enabled, t) === !1) && (!s.suspense || t.state.status !== "error") && J(t, s)
  );
}
function J(t, e) {
  return g(e.enabled, t) !== !1 && t.isStaleByTime(C(e.staleTime, t));
}
function jt(t, e) {
...
var Ut = class extends dt {
  ...
  async execute(t) {
    ...
    this.#i = lt({
      ...
      onFail: (n, o) => {
        this.#n({ type: "failed", failureCount: n, error: o });
      },
      onPause: () => {
        this.#n({ type: "pause" });
      },
    ...
    try {
      ...
      throw (this.#n({ type: "error", error: n }), n);
    } finally {
      this.#s.runNext(this);
    }
  }
...
var xt = class extends D {
  ...
  resumePausedMutations() {
    ...
    return p.batch(() => Promise.all(t.map((e) => e.continue().catch(S))));
  }
};
function x(t) {
...
var Lt = class extends D {
    ...
    #r(t) {
      p.batch(() => {
        if (this.#i && this.hasListeners()) {
          ...
          if (t?.type === "success") {
            try {
              this.#i.onSuccess?.(t.data, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
            try {
              this.#i.onSettled?.(t.data, null, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
          } else if (t?.type === "error") {
            try {
              this.#i.onError?.(t.error, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
            try {
              this.#i.onSettled?.(void 0, t.error, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
          }
  ...
  Ht = class {
    ...
    mount() {
      (this.#r++,
        this.#r === 1 &&
          ((this.#o = W.subscribe(async (t) => {
            t && (await this.resumePausedMutations(), this.#t.onFocus());
          })),
          (this.#a = k.subscribe(async (t) => {
            t && (await this.resumePausedMutations(), this.#t.onOnline());
          }))));
    }
    unmount() {
      (this.#r--,
        this.#r === 0 && (this.#o?.(), (this.#o = void 0), this.#a?.(), (this.#a = void 0)));
    }
    isFetching(t) {
    ...
    ensureQueryData(t) {
      ...
      return i === void 0
        ? this.fetchQuery(t)
        : (t.revalidateIfStale && s.isStaleByTime(C(e.staleTime, s)) && this.prefetchQuery(e),
          Promise.resolve(i));
    }
    getQueriesData(t) {
    ...
    cancelQueries(t, e = {}) {
      ...
      return Promise.all(i).then(S).catch(S);
    }
    ...
    fetchQuery(t) {
      ...
      return s.isStaleByTime(C(e.staleTime, s)) ? s.fetch(e) : Promise.resolve(s.state.data);
    }
    prefetchQuery(t) {
    ...
    resumePausedMutations() {
      return k.isOnline() ? this.#e.resumePausedMutations() : Promise.resolve();
    }
    getQueryCache() {
      return this.#t;
    }
    ...
    setQueryDefaults(t, e) {
      this.#i.set(T(t), { queryKey: t, defaultOptions: e });
    }
    getQueryDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          E(t, i.queryKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
    setMutationDefaults(t, e) {
      this.#n.set(T(t), { mutationKey: t, defaultOptions: e });
    }
    getMutationDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          E(t, i.mutationKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
...
export { Lt as M, Ht as Q, kt as a, p as b, K as e, S as n, Kt as s };
