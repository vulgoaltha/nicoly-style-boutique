...
function m(l) {
  ...
  return function (i) {
    this._ += i[0];
    for (let s = 1, _ = i.length; s < _; ++s) this._ += Math.round(arguments[s] * h) / h + i[s];
  };
}
class q {
  constructor(t) {
  ...
  arcTo(t, h, i, s, _) {
    ...
    if (this._x1 === null) this._append`M${(this._x1 = t)},${(this._y1 = h)}`;
      ...
      if (!(Math.abs(p * o - a * e) > d) || !_) this._append`L${(this._x1 = t)},${(this._y1 = h)}`;
      else {
        let f = i - n,
          M = s - u,
          y = o * o + a * a,
  ...
  arc(t, h, i, s, _, n) {
    ...
    (this._x1 === null
      ? this._append`M${a},${e}`
      : (Math.abs(this._x1 - a) > d || Math.abs(this._y1 - e) > d) && this._append`L${a},${e}`,
      i &&
        ($ < 0 && ($ = ($ % c) + c),
        $ > P
          ? this
