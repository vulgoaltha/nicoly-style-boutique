...
function Wt(t, n) {
  const s = { start: r, center: c, end: o };
  function r() {
    return 0;
  }
  function c(i) {
...
function tn(t, n, s, r) {
  ...
  return { init: u, destroy: h, start: p, stop: b, update: s, render: r };
}
function nn(t, n) {
  const s = n === "rtl",
    r = t === "y",
  ...
  return { scroll: c, cross: o, startEdge: f, endEdge: i, measureSize: u, direction: p };
}
function tt(t = 0, n = 0) {
  const s = P(t - n);
  function r(u) {
...
function kt(t, n, s) {
  ...
  const d = { get: f, set: i, add: u, clone: h };
  return d;
}
function en(t, n, s, r, c, o, e, f, i, u, h, d, p, b, l, m, g, a, S) {
  const { cross: x, direction: T } = t,
    M = ["INPUT", "SELECT", "TEXTAREA"],
    I = { passive: !1 },
    L = dt(),
    E = dt(),
    v = tt(50, 225).constrain(b.measure(20)),
  ...
  function st(y) {
    ...
    const O = n;
    L.add(O, "dragstart", (N) => N.preventDefault(), I)
      .add(O, "touchmove", () => {}, I)
      .add(O, "touchend", () => {})
      .add(O, "touchstart", A)
      .add(O, "mousedown", A)
  ...
  function rt(y, A) {
    const O = d.add(It(y) * -1),
      N = h.byDistance(y, !l).distance;
  ...
  function w(y) {
    const O = h.byDistance(0, !1).index !== d.get(),
      N = o.pointerUp(y) * Q(),
      q = rt(T(N), O),
      X = Jt(N, q),
      Z = V - 10 * X,
...
function sn() {
  function t(s) {
    const { offsetTop: r, offsetLeft: c, offsetWidth: o, offsetHeight: e } = s;
    return { top: r, right: c + o, bottom: r + e, left: c, width: o, height: e };
  }
  return { measure: t };
}
function rn(t) {
...
function un(t, n, s, r, c, o) {
  ...
  function p() {
    ...
    return (
      L
        ? ((e = 0), s.set(r), t.set(r), (E = I))
        : (s.set(t), (e += I / i), (e *= u), (h += e), t.add(e), (E = h - d)),
      (f = It(E)),
      (d = h),
      M
    );
...
function fn(t, n, s, r, c) {
  ...
  function h(b) {
    ...
    const l = t.reachedMin(n.get()) ? "min" : "max",
      ...
      a = f.constrain(m / e);
    (s.subtract(g * a),
      !b && P(g) < o && (s.set(t.constrain(s.get())), r.useDuration(25).useBaseFriction()));
  }
  function d(b) {
    i = !b;
  }
...
function dn(t, n, s, r) {
  const o = n.min + 0.1,
    e = n.max + 0.1,
    { reachedMin: f, reachedMax: i } = tt(o, e);
  function u(p) {
...
function hn(t, n, s, r, c) {
  const { reachedAny: o, removeOffset: e, constrain: f } = r;
  function i(l) {
    return l.concat().sort((m, g) => P(m) - P(g))[0];
  }
  function u(l) {
    const m = t ? e(l) : f(l),
      g = n.map((S, x) => ({ diff: h(S - m, 0), index: x })).sort((S, x) => P(S.diff) - P(x.diff)),
      { index: a } = g[0];
  ...
  function d(l, m) {
    const g = n[l] - c.get(),
      a = h(g, m);
    return { index: l, distance: a };
  }
  function p(l, m) {
    const g = c.get() + l,
      { index: a, distance: S } = u(g),
      x = !t && o(g);
    if (!m || x) return { index: a, distance: l };
    const T = n[a] - S,
      M = l + h(T, 0);
    return { index: a, distance: M };
  }
  return { byDistance: p, byIndex: d, shortcut: h };
}
function Sn(t, n, s, r, c, o, e) {
  function f(d) {
    const p = d.distance,
      b = d.index !== n.get();
    (o.add(p),
      p && (r.duration() ? t.start() : (t.update(), t.render(1), t.update())),
      b && (s.set(n.get()), n.set(d.index), e.emit("select")));
  }
  function i(d, p) {
...
function ut(t) {
  ...
  return { get: s, set: r, add: c, subtract: o };
}
function Gt(t, n) {
  const s = t.scroll === "x" ? e : f,
    r = n.style;
  let c = null,
    o = !1;
  function e(p) {
...
function bn(t, n, s, r, c, o, e, f, i) {
  ...
  function T() {
    p.forEach((L) => {
      const { target: E, translate: v, slideLocation: C } = L,
        D = E();
  ...
  return { canLoop: x, clear: M, loop: T, loopPoints: p };
}
function xn(t, n, s) {
  let r,
    c = !1;
...
function En(t, n, s, r, c, o) {
  ...
  return { slideSizes: p, slideSizesWithGaps: b, startGap: h, endGap: d };
}
function Tn(t, n, s, r, c, o, e, f, i) {
  const { startEdge: u, endEdge: h, direction: d } = t,
    p = Tt(s);
  function b(a, S) {
    return at(a)
      .filter((x) => x % S === 0)
...
function In(t, n, s, r, c, o, e) {
  const {
    ...
    j = !d && !!S,
    J = d || !!S,
    { slideSizes: Y, slideSizesWithGaps: U, startGap: $, endGap: st } = En(D, v, C, s, J, c),
    R = Tn(D, V, g, d, v, C, $, st, L),
    { snaps: nt, snapsAligned: et } = mn(D, H, v, C, R),
    Q = -k(nt) + k(U),
    { snapsContained: rt, scrollContainLimit: it } = an(V, Q, et, S, L),
    z = j ? rt : et,
    { limit: w } = ln(Q, z, d),
    K = kt(pt(z), h, d),
    B = K.clone(),
    F = at(s),
    y = ({ dragHandler: ot, scrollBody: bt, scrollBounds: xt, options: { loop: mt } }) => {
    ...
    A = (
      ...
      const Ot = ot.settled(),
        ...
        wt = Pt ? Ot : Ot && Yt,
        Nt = wt && !Qt.pointerDown();
      Nt && Kt.stop();
      const _t = xt.get() * Ct + qt.get() * (1 - Ct);
      (mt.set(_t),
        Pt && (Ut.loop(ot.direction()), $t.loop()),
        bt.to(mt.get()),
        Nt && Ft.emit("settle"),
        wt || Ft.emit("scroll"));
    },
    ...
    ct = un(X, _, Z, W, p, N),
    ht = hn(d, z, Q, w, W),
    St = Sn(O, K, B, ct, ht, W, e),
    Dt = pn(w),
    At = dt(),
    jt = Ln(n, s, e, m),
    { slideRegistry: Mt } = gn(j, S, z, it, R, F),
    Rt = yn(t, s, Mt, St, ct, At, e, I),
    yt = {
      ownerDocument: r,
      ownerWindow: c,
      eventHandler: e,
...
function vn() {
  ...
  const i = { init: s, emit: c, off: e, on: o, clear: f };
  return i;
}
const Dn = {
  align: "center",
...
function Ht(t, n, s) {
  const r = t.ownerDocument,
    ...
    f = dt(),
    i = vn(),
    { mergeOptions: u, optionsAtMedia: h, optionsMediaQueries: d } = o,
    { on: p, off: b, emit: l } = i,
    m = D;
  let g = !1,
    a,
    S = u(Dn, Ht.globalOptions),
    x = u(S),
    T = [],
    M,
    I,
  ...
  function C(F, y) {
    g ||
      ...
      E(),
      (a = v(x)),
      d([S, ...T.map(({ options: A }) => A)]).forEach((A) => f.add(A, "change", D)),
      x.active &&
        ...
        I.offsetParent && L.length && a.dragHandler.init(B),
        (M = e.init(B, T))));
  }
  function D(F, y) {
    const A = R();
  ...
  function H(F, y, A) {
    !x.active ||
      g ||
      (a.scrollBody.useBaseFriction().useDuration(y === !0 ? 0 : x.duration),
