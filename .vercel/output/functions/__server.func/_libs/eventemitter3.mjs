    ...
    E ||
      ...
      (function (g) {
        var w = Object.prototype.hasOwnProperty,
          c = "~";
        function h() {}
        Object.create && ((h.prototype = Object.create(null)), new h().__proto__ || (c = !1));
        function d(s, t, n) {
        ...
        function m(s, t, n, r, l) {
          ...
          return (
            s._events[o]
              ? s._events[o].fn
                ? (s._events[o] = [s._events[o], u])
                : s._events[o].push(u)
              : ((s._events[o] = u), s._eventsCount++),
            s
          );
        }
        function y(s, t) {
        ...
        ((f.prototype.eventNames = function () {
          ...
          for (r in (n = this._events)) w.call(n, r) && t.push(c ? r.slice(1) : r);
          ...
          (f.prototype.emit = function (t, n, r, l, u, o) {
            ...
            if (e.fn) {
              ...
              for (i = 1, p = new Array(v - 1); i < v; i++) p[i - 1] = arguments[i];
              ...
              for (i = 0; i < b; i++)
                switch ((e[i].once && this.removeListener(t, e[i].fn, void 0, !0), v)) {
                  ...
                  case 4:
                    ...
                    break;
                  default:
                    if (!p) for (_ = 1, p = new Array(v - 1); _ < v; _++) p[_ - 1] = arguments[_];
