import { r as s, j as d } from "./react.mjs";
import { c as p } from "./radix-ui__primitive.mjs";
import { c as H } from "./radix-ui__react-collection.mjs";
import { u as V } from "./radix-ui__react-compose-refs.mjs";
import { c as z } from "./radix-ui__react-context.mjs";
import { u as q } from "./radix-ui__react-id.mjs";
import { P as G } from "./radix-ui__react-primitive.mjs";
import { u as J } from "./@radix-ui/react-use-callback-ref+[...].mjs";
import { u as Q } from "./@radix-ui/react-use-controllable-state+[...].mjs";
...
var te = s.forwardRef((e, r) => {
    const {
      ...
      g = V(r, F),
      R = W(w),
      [E, t] = Q({ prop: v, defaultProp: C ?? null, onChange: S, caller: I }),
      [i, x] = s.useState(!1),
      u = J(m),
      l = N(c),
      h = s.useRef(!1),
...
var ge = O,
  Re = j;
export { Re as I, ge as R, Fe as c };
