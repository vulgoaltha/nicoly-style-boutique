...
import { T as f, c as y, A as N, S as _, a5 as w } from "../_libs/lucide-react.mjs";
...
function M() {
  const o = b(),
    ...
    m = async (s) => {
      ...
      const { error: a } = await d.from("homepage_collections").delete().eq("id", s);
      if (a) return u.error(a.message);
      (p(), o.invalidateQueries({ queryKey: ["homepage-collections"] }));
    },
    n = async (s, a) => {
      (await d
        .from("homepage_collections")
        ...
        .eq("id", s.id),
        o.invalidateQueries({ queryKey: ["admin-collections"] }),
        o.invalidateQueries({ queryKey: ["homepage-collections"] }));
    };
  return e.jsxs("div", {
    children: [
      e.jsxs("div", {
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsxs("div", {
                            ...
                            children: [s.subtitle, " · ", s.redirect_url],
                          }),
                          e.jsxs("div", {
...
function k({ item: o, onClose: l, onSaved: p }) {
  const [r, i] = x.useState(o),
    [m, n] = x.useState(!1),
    s = async (t) => {
      ...
      const h = {
        ...
        { error: g } = r.id
          ? await d.from("homepage_collections").update(h).eq("id", r.id)
    ...
    children: e.jsxs("form", {
      ...
      children: [
        e.jsx("h2", {
          ...
          children: r.id ? "Editar coleção" : "Nova coleção",
        }),
        e.jsxs("div", {
          children: [
            ...
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("input", {
                  ...
                  onChange: (t) => i({ ...r, redirect_url: t.target.value }),
                }),
              ],
            }),
            e.jsxs("div", {
