import { r as p, j as e } from "../_libs/react.mjs";
import { b as g, a as v } from "../_libs/tanstack__react-query.mjs";
import { t as d } from "../_libs/sonner.mjs";
import { p as m } from "./client-DbGX8m2J.mjs";
import { $ as j } from "./ImageUploader-rngdoTXs.mjs";
import "../_libs/browser-image-compression.mjs";
import { T as f, c as N, A as y, S as _, a5 as k } from "../_libs/lucide-react.mjs";
...
function M() {
  const o = g(),
    ...
    u = async (s) => {
      ...
      const { error: a } = await m.from("hero_banners").delete().eq("id", s);
    ...
    c = async (s, a) => {
      const { error: n } = await m
        .from("hero_banners")
        .update({ order_position: s.order_position + a })
        .eq("id", s.id);
      if (n) return d.error(n.message);
...
function w({ banner: o, onClose: l, onSaved: x }) {
  const [r, i] = p.useState(o),
    [u, c] = p.useState(!1),
    s = async (t) => {
      if ((t.preventDefault(), !r.title || !r.image_url))
      ...
      const b = {
        ...
        { error: h } = r.id
          ? await m.from("hero_banners").update(b).eq("id", r.id)
    ...
    n = "text-xs tracking-editorial uppercase mb-1.5 block";
  return e.jsx("div", {
    className:
    ...
    children: e.jsxs("form", {
      ...
      children: [
        e.jsx("h2", {
          ...
          children: r.id ? "Editar banner" : "Novo banner",
        }),
        e.jsxs("div", {
          children: [
            e.jsx("label", { className: n, children: "Imagem *" }),
            e.jsx(j, {
              value: r.image_url,
              onChange: (t) => i({ ...r, image_url: t }),
              folder: "banners",
            }),
          ],
        }),
        e.jsxs("div", {
          children: [
            e.jsx("label", { className: n, children: "Título *" }),
            e.jsx("input", {
              className: a,
              value: r.title,
              onChange: (t) => i({ ...r, title: t.target.value }),
              required: !0,
            }),
          ],
        }),
        e.jsxs("div", {
          children: [
            e.jsx("label", { className: n, children: "Subtítulo" }),
            e.jsx("textarea", {
              className: a,
              rows: 2,
              value: r.subtitle ?? "",
              onChange: (t) => i({ ...r, subtitle: t.target.value }),
            }),
          ],
        }),
        e.jsxs("div", {
          ...
          children: [
            e.jsxs("div", {
              children: [
                e.jsx("label", { className: n, children: "Texto do botão" }),
                e.jsx("input", {
                  className: a,
                  value: r.button_text ?? "",
                  onChange: (t) => i({ ...r, button_text: t.target.value }),
                }),
              ],
            }),
            e.jsxs("div", {
              children: [
                e.jsx("label", { className: n, children: "Link do botão" }),
                e.jsx("input", {
                  className: a,
                  placeholder: "/loja",
                  value: r.button_link ?? "",
                  onChange: (t) => i({ ...r, button_link: t.target.value }),
                }),
              ],
            }),
            e.jsxs("div", {
              children: [
                e.jsx("label", { className: n, children: "Ordem" }),
                e.jsx("input", {
                  type: "number",
                  className: a,
                  value: r.order_position,
                  onChange: (t) => i({ ...r, order_position: parseInt(t.target.value || "0") }),
                }),
              ],
            }),
            e.jsxs("label", {
              ...
              children: [
                e.jsx("input", {
                  type: "checkbox",
                  checked: r.active,
                  onChange: (t) => i({ ...r, active: t.target.checked }),
                }),
                "Ativo",
              ],
            }),
