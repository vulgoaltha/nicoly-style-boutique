...
import { L as t } from "../_libs/tanstack__react-router.mjs";
import { f as r } from "./router-CzERE3r3.mjs";
import { r as i } from "./format-W46puzMN.mjs";
import "../_libs/seroval.mjs";
import "../_libs/sonner.mjs";
import { ag as n, N as c, T as x, _ as p } from "../_libs/lucide-react.mjs";
...
function se() {
  ...
  return o.length
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("div", {
                ...
                children: o.map((s) => {
                  const d = `${s.productId}_${s.size ?? ""}_${s.color ?? ""}`;
                  return e.jsxs(
                    "div",
                    {
                          ...
                          children: [
                            e.jsxs("div", {
                              ...
                              children: [
                                ...
                                e.jsx("button", {
                                  onClick: () => l(s.productId, s.size, s.color),
                                  className:
                              ...
                              children: [
                                e.jsxs("div", {
                                  ...
                                  children: [
                                    e.jsx("button", {
                                      onClick: () =>
                                        m(s.productId, s.quantity - 1, s.size, s.color),
                                      className: "flex h-9 w-9 items-center justify-center",
                                      "aria-label": "Diminuir quantidade",
                                      children: e.jsx(c, { className: "h-3 w-3" }),
                                    }),
                                    e.jsx("span", {
                                    ...
                                    e.jsx("button", {
                                      ...
                                      children: e.jsx(x, { className: "h-3 w-3" }),
                                    }),
                                  ],
                                }),
                                e.jsx("div", {
                                  className: "font-medium text-sm",
                                  children: i(s.price * s.quantity),
                                }),
                              ],
                            }),
                          ],
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  ...
                  e.jsx("div", { className: "font-display text-lg font-medium", children: i(a) }),
                ],
              }),
              e.jsx(t, {
                to: "/checkout",
    ...
    : e.jsxs("div", {
        ...
        children: [
          e.jsx(p, { className: "h-12 w-12 mx-auto text-muted-foreground" }),
          e.jsx("h1", {
