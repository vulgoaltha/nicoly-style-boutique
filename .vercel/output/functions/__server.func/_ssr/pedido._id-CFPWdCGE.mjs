...
import { L as o } from "../_libs/tanstack__react-router.mjs";
import { a as j } from "../_libs/tanstack__react-query.mjs";
import { p as m } from "./client-DbGX8m2J.mjs";
import { r as s } from "./format-W46puzMN.mjs";
import { O as f, A as b } from "./PixDisplay-ITjio8rx.mjs";
import { b as g } from "./router-CzERE3r3.mjs";
import "../_libs/sonner.mjs";
import "../_libs/seroval.mjs";
import { o as N } from "../_libs/lucide-react.mjs";
...
function ce() {
  const { id: i } = g.useParams(),
    {
      ...
      queryKey: ["order", i],
      queryFn: async () => {
        const [{ data: t, error: a }, { data: h, error: n }] = await Promise.all([
          m.from("orders").select("*").eq("id", i).maybeSingle(),
          m.from("order_items").select("*").eq("order_id", i),
        ]);
        if (a) throw a;
        if (n) throw n;
        return { order: t, items: h ?? [] };
      },
    });
  if (c)
    return e.jsx("div", {
  ...
  const { order: r, items: p } = d,
    x = r.payment_status ?? "unknown",
    u =
      r.payment_method === "pix"
        ? "pix"
        : r.payment_method === "credit_card"
          ? "credit_card"
          : r.payment_method === "debit_card"
            ? "debit_card"
            : r.payment_method === "mercado_pago_balance"
      ...
      e.jsxs("div", {
        ...
        children: [
          ...
          e.jsxs("p", {
            ...
            children: [
              "Numero ",
              e.jsx("span", { className: "font-medium text-foreground", children: r.order_number }),
              " · Status:",
              " ",
              _[r.status || ""] ?? r.status,
            ],
                  ...
                  children: [
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsxs("div", {
                          children: [
                            e.jsx("div", { className: "font-medium", children: t.product_name }),
                            e.jsxs("div", {
                              className: "text-xs text-muted-foreground mt-1",
                              children: [
                                t.size &&
                                  e.jsxs(e.Fragment, { children: ["Tam: ", t.size, " · "] }),
                                t.color &&
                                  e.jsxs(e.Fragment, { children: ["Cor: ", t.color, " · "] }),
                                "Qtd: ",
                                t.quantity,
                              ],
                            }),
                        ...
                        e.jsx("div", {
                          ...
                          children: s(Number(t.unit_price) * t.quantity),
                        }),
                      ],
                    }),
                  ],
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  ...
                  e.jsx("span", { children: s(Number(r.subtotal)) }),
                ],
              }),
              e.jsxs("div", {
                className: "flex justify-between",
                children: [
                  ...
                  e.jsx("span", { children: s(Number(r.shipping_cost)) }),
                ],
              }),
              e.jsxs("div", {
                className:
                ...
                children: [
                  ...
                  e.jsx("span", { children: s(Number(r.total)) }),
                ],
              }),
            ],
          }),
        ...
        children: [
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsx("div", { children: r.customer_name }),
              e.jsx("div", { className: "text-muted-foreground", children: r.customer_email }),
              e.jsx("div", { className: "text-muted-foreground", children: r.customer_phone }),
            ],
          }),
          e.jsxs("div", {
            className: "border border-border rounded-sm p-5",
            children: [
              ...
              e.jsxs("div", {
                children: [
                  ...
                  ", ",
                  r.shipping_number,
                  r.shipping_complement ? ` · ${r.shipping_complement}` : "",
                ],
              }),
              e.jsxs("div", {
                className: "text-muted-foreground",
                children: [r.shipping_neighborhood, " · ", r.shipping_city, "/", r.shipping_state],
              }),
              e.jsxs("div", {
                className: "text-muted-foreground",
                children: ["CEP ", r.shipping_cep],
              }),
              r.tracking_code &&
                e.jsxs("div", {
